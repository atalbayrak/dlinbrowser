...
all_categories= ['hobbit', 'ainur', 'dwarf', 'man', 'elf']
...
def generate(category, start_letter='A'):
...
rnn.load_state_dict(torch.load('model/name_lotr.pth'))
rnn.eval()
...
st.text('Generated name is : ' + generate(race.lower(),username))
